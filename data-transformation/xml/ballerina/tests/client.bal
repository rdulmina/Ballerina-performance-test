...
function testFunction() {
    ...
    map<map<Order[]>> expected = {"buyStocks": {"order": [{"symbol": "N", "buyerID": "n", "price": 1.0, "volume": 1}, {"symbol": "SUN", "buyerID": "indika", "price": 14.56, "volume": 500}]}};
    map<map<Order[]>> actual = checkpanic (checkpanic response.getJsonPayload()).cloneWithType();
